...
#sa se afiseze primele 2 minime si ultimele 2 maxime ale listei de temperaturi
temperaturi1 = sorted (temperaturi)

print(temperaturi1)
print('')
print("Cele mai mari temperaturi sunt: " , temperaturi1[-2] , temperaturi1[-1])
print("Cele mai mici temperaturi sunt: " , temperaturi1[0] , temperaturi1[1])
...
#sa se afiseze de cate ori apare cuvantul "is"
word = "is"
i = 0
for word in words:
    i=i+1
...
#sa se afiseze de cate ori apare fiecare cuvant din lista
result = []
for word in words:
